...
if hostname == 'projector-pi-1':
    ...
    cam1IP = '192.168.123.39'
    cam2IP = '192.168.123.40'
    stream1 = 'rtsp://admin:wifll999999@192.168.123.39:554/cam/realmonitor?channel=1&subtype=0'
    stream2 = 'rtsp://admin:wifll999999@192.168.123.40:554/cam/realmonitor?channel=1&subtype=0'
elif hostname == 'projector-pi-10':
    cam1IP = '192.168.123.41'
    cam2IP = '192.168.123.42'
    stream1 = 'rtsp://admin:wifll999@192.168.123.41:554/cam/realmonitor?channel=1&subtype=0'
    stream2 = 'rtsp://admin:wifll999@192.168.123.42:554/cam/realmonitor?channel=1&subtype=0'
else:
    sys.exit()
